...
public class LAppMinimumDelegate {
    ...
    public void onSurfaceCreated() {
        ...
        // Guarded: the surface can be created before a model has been chosen, and
        // the sample assumed one was always loaded first.
        if (live2DManager.hasModel()) {
    ...
    public void run() {
        ...
        // A service has no window to finish; the activity-specific teardown from
        // the sample is dropped rather than translated.
    }
